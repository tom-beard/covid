...
Looking at raw case numbers, the peak on `r peak_cases$report_date` was about `r round(maxima$cases / minima$cases, digits = 1)` times what it is now.

But when adjusting for the weekly pattern, it was `r round(maxima$adjusted / minima$adjusted, digits = 1)` times the current adjusted value, and the trend was about `r round(maxima$trend / minima$trend, digits = 1)` times the current trend line.
